...
- 箇条書きについては原文の内容を尊重したうえで文章化せよ
  ...
  - 基本的に箇条書きは文章のエッセンスなので、それをもとにして読者が読みやすい・理解しやすい説明へと昇華させることを意識せよ
...
- 文章の量や説明の内容に応じて適切に段落分けする
  ...
  - 段落はある程度のまとまりになるように意識せよ。特に2文程度の短い段落が連続して続くと読みづらい
  - 一方で一節が一段落だけになる構成も見づらい。段落の読みやすさと章・節の構成が適切になるよう調整せよ
  - h4以降を使うのは極力避け、箇条書きなども併用して読みやすい・見やすい構成にせよ
- 全体的に箇条書き、走り書きは必要最低限の情報しかないため、補足が必要な場合は適宜説明を追加せよ
  - 文章間、行間を補足するような情報は適宜追加せよ
  - 読者の理解しやすさを促進するように説明を補足せよ。無駄に長くする必要はないが、読者がこれを読んだときに一度で理解できるようにという意識をもって
- 元の箇条書きのエッセンスをちゃんと保てるなら文章構成を変えても良い
  - むしろより読者がわかりやすくなるように文章の順序やかたまりなどを含めて調整するのが望ましい
  - 文章構成の特徴は他の記事と平仄をあわせよ
